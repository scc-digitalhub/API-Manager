package it.smartcommunitylab.wso2aac.provisioning;
...
import it.smartcommunitylab.wso2aac.provisioning.internal.AACProvisionServiceComponent;
...
public class AACProvisioningHandler implements ProvisioningHandler {
	    ...
	    public void handle(List<String> roles, String subject, Map<String, String> attributes,
	    	...
	    	tenantDomain="testingg.com";
	        subject += "@"+tenantDomain;
	        log.info(subject);
	                
	        RegistryService registryService = AACProvisionServiceComponent.getRegistryService();
	        RealmService realmService = AACProvisionServiceComponent.getRealmService();
