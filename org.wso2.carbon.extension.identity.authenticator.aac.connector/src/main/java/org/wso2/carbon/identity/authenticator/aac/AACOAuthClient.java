...
public class AACOAuthClient extends OAuthClient {

    public AACOAuthClient(HttpClient oauthClient) {
        super(oauthClient);
    }
    ...
    public <T extends OAuthAccessTokenResponse> T accessToken(
        ...
        headers.put(AACAuthenticatorConstants.ACCEPT_HEADER, OAuth.ContentType.JSON);
