...
keytool -import -alias letsca -file lets-encrypt-x3-cross-signed.pem -keystore ${WSO2_SERVER_HOME}/repository/resources/security/client-truststore.jks -storepass wso2carbon -noprompt
bash apim-config.sh
