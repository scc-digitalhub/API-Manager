...
if [ ! -z ${AAC_HOSTNAME} ]; then
  ...
  xml_add 'IntrospectionURL' "${AAC_HOSTNAME}/oauth/introspect" '/APIManager/APIKeyManager/Configuration' "${conf_path}/${conf_file}"
  ...
  xml_replace 'RevokeURL' "${AAC_HOSTNAME}/oauth/revoke" '/APIManager/APIKeyManager/Configuration' "${conf_path}/${conf_file}"
